using System.Net;
using AspNetCore_net10._0_TestApp;
using AspNetCore_net10._0_TestApp.Authentication;
using AspNetCore_net10._0_TestApp.Endpoints;
using AspNetCore_net10._0_TestApp.Services;
            ...
            OnAuthorizeAsync = ctx =>
            {
                ...
                if (ctx.HttpContext.User.Identity?.IsAuthenticated != true)
                {
                    ctx.HttpContext.Response.Headers.Append(
                        "WWW-Authenticate",
                        new StringValues("Basic realm=tusdotnet-test-net10.0")
                    );
