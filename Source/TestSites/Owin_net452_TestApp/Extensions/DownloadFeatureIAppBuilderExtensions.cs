        ...
        )
        {
            app.Use(
                async (context, next) =>
                {
                    ...
                    if (
                        context.Request.Uri.LocalPath.StartsWith(
                    ...
                    {
                        var fileId = context
                            .Request.Uri.LocalPath.Replace(tusConfiguration.UrlPath, "")
                            .Trim('/', ' ');
                        if (!string.IsNullOrEmpty(fileId))
                        {
                            var readableStore = (ITusReadableStore)tusConfiguration.Store;
                            var file = await readableStore.GetFileAsync(
                                fileId,
                    ...
                    switch (context.Request.Uri.LocalPath)
                    {
                        ...
                        case "/tus.min.js":
                            ...
                            await context.Response.WriteAsync(
                                File.ReadAllText("../../wwwroot/tus.min.js"),
                                context.Request.CallCancelled
                            );
                            break;
                        case "/index.js":
                            context.Response.ContentType = "application/js";
                            await context.Response.WriteAsync(
                                File.ReadAllText("../../wwwroot/index.js"),
                                context.Request.CallCancelled
                            );
                            break;
                        case "/index.css":
                            ...
                            await context.Response.WriteAsync(
                                File.ReadAllText("../../wwwroot/index.css"),
                                context.Request.CallCancelled
                            );
                            break;
                        default:
