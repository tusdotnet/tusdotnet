...
namespace tusdotnet.Stores
{
    ...
    public class TusDiskBufferSize
    {
        ...
        /// <param name="readBufferSizeInBytes">The number of bytes to read at the time from the request. The lower the value, the less data needs to be re-submitted on errors. However, the lower the value, the slower the operation is.</param>
