    ...
    public class TusExtensions
    {
        ...
        public TusExtensions(params TusExtensions[] extensions)
        {
            _extensionNamesInUse = new HashSet<string>(
                extensions.SelectMany(x => x._extensionNamesInUse)
            );
        }
        ...
        {
            _extensionNamesInUse = new HashSet<string> { extensionName };
        }

#pragma warning disable CS1591 // Missing XML comment for publicly visible type or member

        public static TusExtensions Checksum { get; } =
            new TusExtensions(ExtensionConstants.Checksum);

        public static TusExtensions ChecksumTrailer { get; } =
            new TusExtensions(ExtensionConstants.ChecksumTrailer);

        public static TusExtensions Concatenation { get; } =
            new TusExtensions(ExtensionConstants.Concatenation);

        public static TusExtensions Creation { get; } =
            new TusExtensions(ExtensionConstants.Creation);

        public static TusExtensions CreationDeferLength { get; } =
            new TusExtensions(ExtensionConstants.CreationDeferLength);

        public static TusExtensions CreationWithUpload { get; } =
            new TusExtensions(ExtensionConstants.CreationWithUpload);

        public static TusExtensions Expiration { get; } =
            new TusExtensions(ExtensionConstants.Expiration);

        public static TusExtensions Termination { get; } =
            new TusExtensions(ExtensionConstants.Termination);
...
#pragma warning restore CS1591 // Missing XML comment for publicly visible type or member
        ...
        /// </summary>
        public static TusExtensions All { get; } =
            new(
                Creation,
                CreationDeferLength,
                CreationWithUpload,
        ...
        /// </summary>
        internal IEnumerable<string> Disallowed =>
            All._extensionNamesInUse.Except(_extensionNamesInUse);
