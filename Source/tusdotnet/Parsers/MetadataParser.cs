...
namespace tusdotnet.Parsers
{
    ...
    public static class MetadataParser
    {
        ...
        public static MetadataParserResult ParseAndValidate(
        ...
        )
        {
            ...
            * */
            ...
            return strategy == MetadataParsingStrategy.AllowEmptyValues
                ...
                : MetadataParserStringBased.ParseAndValidate(
                    OriginalMetadataParserStringBased.Instance,
                    uploadMetadataHeaderValue
                );

#else

            var parser = (IInternalMetadataParser)(
                strategy == MetadataParsingStrategy.Original
                    ? OriginalMetadataParserStringBased.Instance
                    : AllowEmptyValuesMetadataParserStringBased.Instance
            );
