...
namespace tusdotnet.test.Extensions
{
    internal static class RequestBuilderExtensions
    {
        ...
        internal static RequestBuilder AddHeaderIfNotEmpty(
        ...
        internal static RequestBuilder CreateTusResumableRequest(
        ...
        internal static RequestBuilder OverrideHttpMethodIfNeeded(
            this RequestBuilder builder,
            string @override,
            string method
        )
