...
namespace tusdotnet.test.Tests.ModelTests
{
    ...
    {
        private const string UploadMetadata =
            "filename d29ybGRfZG9taW5hdGlvbl9wbGFuLnBkZg==,othermeta c29tZSBvdGhlciBkYXRh,utf8key wrbDgMSaxafMsw==";
        private const string UploadMetadataWithEmptyValue =
            "filename d29ybGRfZG9taW5hdGlvbl9wbGFuLnBkZg==,othermeta c29tZSBvdGhlciBkYXRh,empty_key";
        private const string UploadMetadataWithDuplicateKey =
            "filename d29ybGRfZG9taW5hdGlvbl9wbGFuLnBkZg==,filename c29tZSBvdGhlciBkYXRh";
        private const string UploadMetadataWithInvalidBase64 =
            "filename d29ybGRfZG9taW5hdGlvbl9wbGFuLnBkZg";
        private const string NoLetterCasingMetadata =
        ...
        [Theory]
        [MemberData(nameof(ParsingStrategies))]
        public void Returns_Empty_Dictionary_If_UploadMetadata_Header_Is_Null_Or_Empty(
            MetadataParsingStrategy? strategy
        )
        {
        ...
        private static Dictionary<string, Metadata> Parse(
            MetadataParsingStrategy? strategy,
        ...
        public static IEnumerable<object[]> ParsingStrategies =>
            new List<object[]>(3)
            {
